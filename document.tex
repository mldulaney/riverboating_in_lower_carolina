...
The Cape Fear steamers where the \textit{Henrietta}, which was built
at Fayetteville by James Seawell to run between that point and
Wilmington, and the \textit{Prometheus}, which was built at Beaufort
by Captain Otway Burns, famed as master of the privateer
\textit{Snap~Dragon}, for a stock company, which may have been the
Cape Fear Navigation Company.  The \textit{Prometheus} was put in
service on the lower river between Wilmington and Smithville, now
Southport.\par

The Neuse steamer was the \textit{Norfolk}, built out of state and
purchased by the New Bern Steamboat Company.  Thomas H. Sloan in his
\textit{Inland Steam Navigation in North Carolina 1818-1900}, citing
the New Bern \textit{Centinel} of April 11, 1818, states that the
\textit{Norfolk} arrived in New Bern April 10 and thus became the
first steamer to go into service in the state.  Twenty days later, on
April 30, according to the May 9 Centinel, the Henrietta was launched
on the Cape Fear; and the July 23 \textit{National Intelligencer} of
Washington D.~C., tells of her first trip to Wilmington.  The June 13
\textit{Intelligencer} had stated that the \textit{Prometheus} had
arrived at Wilmington and that within a few days she would probably
commence running from that place to Smithville.\par

These reports seem to establish the \textit{Norfolk} as the first
steamboat service in North Carolina and the \textit{Henrietta} as the
first steamship built in this state.\par

However, unsuccessful steps to introduce steamboat service had been
taken several years earlier.  Robert Fulton had made his first
successful voyage on the Hudson River with his steamboat
\textit{Claremont} eleven years before the \textit{Henrietta} and the
\textit{Prometheus} began service on the Cape Fear.\par
...
steamboat \textit{Henrietta} had run the river for twenty years
without being snagged or meeting with any serious accident.
\citep[12, 13]{turlingtonsw}.\par

After turning down a petition in 1817 by Joseph Seawell of
Fayetteville, the General Assembly of the following year granted him a
monopoly for steam navigation between Wilmington and Fayetteville.
His petition stated that he had a boat under construction.\par

The bill gave Seawell and his associates ``the sole and exclusive
right and privilege of using, employing, and navigating all and every
species or kinds of boats propelled by the force of steam on the
waters of the Cape Fear river between the towns of Fayetteville and
Wilmington for and during the full term of seven years from and after
the passage of this act.''
\citep[22]{turlingtonsw}\citep[13]{sloanth}.\par

Launching of the \textit{Henrietta} at Fayetteville and arrival of the
\textit{Prometheus} at Wilmington were met with great enthusiasm.\par

\section*{The \textit{Prometheus}}

The \textit{Prometheus} was brought down from Beaufort by Captain
Thomas N.~Gautier, a worthy old sea captain.  Colonel J.~G.~Burr told
the story of her arrival to James Sprunt who gives it in his
...
enthusiasm when it was announced that the \textit{Prometheus} was in
...
\textit{Prometheus} snorted by, amid the cheers of the excited
multitude.''  \citep[139]{spruntj1916}.\par

The \textit{Prometheus} was in operation in 1819 when President James
...
But the low-powered \textit{Prometheus} seems to have been less than a
